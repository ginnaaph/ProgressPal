...
//     variants: {
//       variant: {
//         default: 'bg-[#AFA2CE] text-white shadow hover:bg-[#AFA2CE]/60 rounded-md',
//         destructive: 'bg-secondary text-white shadow-sm hover:bg-secondary/90 rounded-md',
//         outline:
...
//         ghost: 'hover:bg-primary-alt text-text-secondary hover:text-text-secondary rounded-md',
